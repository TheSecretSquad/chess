...
public class ChessBoardTest {
	...
	@Test
	public void shouldSendMovesForPieceAtSquareWhenSendingMoves() {
		chessBoard.placePieceAt(piece, Square.A1);
		chessBoard.sendMovesForSquareTo(Square.A1, movesReceiver);
		verify(piece).describeMovesTo(movesReceiver);
	}
}